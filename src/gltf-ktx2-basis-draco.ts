// npx @gltf-transform/cli draco cottage-basis.glb cottage-basis-draco.glb

import { Renderer, Camera, Transform, Orbit, Program, BasisManager, DracoManager, GLTFLoader, Vec3, TextureLoader, Mesh } from 'ogl';
...

{
    ...
    async function loadInitial() {
        // Note: these are the only added lines from the load-gltf example
        ...
        gltf = await GLTFLoader.load(gl, `assets/gltf/cottage-basis-draco.glb`);
        addGLTF(gltf);
    }
