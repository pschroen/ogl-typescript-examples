import { Renderer, Transform, Camera, Geometry, Texture, Program, Mesh, Vec3, Color, Orbit, Plane } from 'ogl';
...

{
    ...
    function getTexture(src: string, generateMipmaps: boolean = true) {
